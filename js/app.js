...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["dyttzy","ruyi","bfzy","tyyszy","ffzy","heimuer","zy360","iqiyi","wolong","hwba","jisu","dbzy","mozhua","mdzy","zuid","yinghua","baidu","wujin","okzy","wwzy","ikun","ckzy","jkun","bwzy","souav","r155","lsb","huangcang","yutu"];
